                ...
                <div class="col-lg-4">
                    <div class="card cardcheck" style="max-height:60vh;overflow-y:scroll;">
                        <div class="card-header">
                            ...
                            <br>
                            <hr>
                            <form action="{{ url('tourist/book-accomodation-days/' . $accomodation->id) }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="">No. of Days/Nights</label>
                                    <input type="number" min="1" name="days_spent" class="form-control" required>
                                </div>
                                <button class="btn btn-block btn-success" type="submit">Book Accomodation Now</button>
                            </form>
