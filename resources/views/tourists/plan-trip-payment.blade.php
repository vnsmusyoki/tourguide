...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card cardcheck" style="max-height:60vh;overflow-y:scroll;">
            <div class="card-header">
                <h5 class="card-title">{{ $accomodationcheck->accomodationcheck_name }}</h5>
                <hr>
                <img src="{{ asset('storage/accomodationchecks/' . $accomodationcheck->picture) }}" class="img-fluid" alt="">
                <br>
                <strong>
                ...
                <br>
                <hr>
                <form action="{{ url('tourist/upload-accomodationcheck-payments/' . $accomodationcheck->id) }}" method="POST">
                    <h5>Pay Kshs. {{ $totalprice }} and provide the transaction code in the field below</h5>
                    @csrf
                    <div class="form-group">
                        <label for="">Price Per Night</label>
                        <input type="text" value="{{ $accomodationcheck->price_per_night }}" readonly class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-block btn-success" type="submit">Upload Payments dNow</button>
                </form>
