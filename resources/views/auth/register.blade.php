                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                ...
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                    <span>So easy To get Started</span>
                                </h6>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" action="{{ url('create-new-account') }}"
                                        method="POST" autocomplete="off">
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input type="text" class="form-control form-control-lg" id="user-name"
                                                placeholder="Your Full Name" name="full_names"
                                                value="{{ old('login') }}">
                                            @error('full_names')
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control form-control-lg"
                                                id="user-password" placeholder="Confirm Password"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-12 text-center text-sm-right"><a
                                                    href="{{ route('login') }}" class="card-link">Return to
                                                    Login
                                                </a></div>
                                        </div>
                                        <button type="submit" class="btn btn-danger btn-lg btn-block"> Create New
                                            Account</button>
                                    </form>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="">
                                    ...
                                    <p class="float-sm-right text-center m-0">New to Tours Management? <a
                                            href="{{ route('login') }}" class="card-link">Sign In</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
