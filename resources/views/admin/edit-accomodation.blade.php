        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Upload Edited Accomodation Details</h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ url('admin/update-accomodation/' . $accomodation->id) }}" method="POST"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="100" class="form-control" name="accomodation_price"
                                            value="{{ $accomodation->price_per_night }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="site_description" class="form-control" id="" cols="30"
                                            rows="10">{{ $accomodation->description }}</textarea>
